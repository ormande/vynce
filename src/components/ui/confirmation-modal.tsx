...
export function ConfirmationModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/65 backdrop-blur-md">
      ...
      <div className="relative w-full max-w-md rounded-[28px] border border-white/20 bg-[var(--panel-strong)] shadow-[0_40px_100px_rgba(0,0,0,0.35)] overflow-hidden flex flex-col">
