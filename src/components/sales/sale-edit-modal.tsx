...
export function SaleEditModal({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className={`relative flex max-h-[90vh] w-full max-w-2xl flex-col rounded-[28px] border border-white/20 bg-[var(--panel-strong)] shadow-[0_40px_100px_rgba(0,0,0,0.35)] ${isClosing ? "animate-modal-out" : "animate-modal-in"}`}
      >
